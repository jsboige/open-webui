...
app.state.config.AUDIO_STT_WHISPER_WEBUI_BASE_URL = AUDIO_STT_WHISPER_WEBUI_BASE_URL
app.state.config.AUDIO_STT_WHISPER_WEBUI_USERNAME = AUDIO_STT_WHISPER_WEBUI_USERNAME
app.state.config.AUDIO_STT_WHISPER_WEBUI_PASSWORD = AUDIO_STT_WHISPER_WEBUI_PASSWORD
